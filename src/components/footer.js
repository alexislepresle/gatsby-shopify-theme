    ...
    return (
        <footer className="footer">
            <div className="content has-text-centered">
                <p><strong>Gatsby x Shopify</strong> by <a className="has-text-danger-dark" href="https://www.alexislepresle.com" target="_blank" rel="noopener noreferrer">Alexis Lepresle</a> (Fake store with <a className="has-text-danger-dark" target="_blank" rel="noopener noreferrer" href="https://www.shop.dev.to">Dev.to</a> products)</p>
